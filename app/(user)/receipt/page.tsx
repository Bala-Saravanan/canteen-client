...
//         {/* Order type + payment method chips */}
...
//             }}
//           >
//             <span style={{ fontSize: "22px" }}>{ot?.icon}</span>
//             <div>
//               <p
//                 style={{
//                   fontFamily: "var(--font-display)",
...
export default function ReceiptPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className="card receipt-card animate-fade-up"
        style={{ padding: "36px", position: "relative", overflow: "hidden" }}
      >
        {/* Top accent strip */}
        <div
        ...
        {/* Meta grid — 2-col on desktop, 1-col on small phones */}
        <div
        ...
        {/* Order type + payment — always flex row, wraps on tiny screens */}
        <div
          style={{
            display: "flex",
            gap: "10px",
